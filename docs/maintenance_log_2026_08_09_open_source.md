...
- 按 GitHub 公共仓库规范补充 Bug/功能 Issue 表单、私密安全报告入口、Pull Request 检查清单和 Dependabot 配置；CI 增加 `static/i18n.js` 语法检查。
- 发现 `v1.5.0` 标签落后于安全加固提交；不重写旧标签，统一版本号为 `1.5.1` 并创建对应源码 Release。
